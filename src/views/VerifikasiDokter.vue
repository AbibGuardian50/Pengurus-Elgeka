    ...
    <div class="flex">
        ...
        <div>
            ...
            <table class="ml-8 min-w-full divide-y divide-gray-200 overflow-x-auto w-[1200px]">
                ...
                <tbody>
                    <tr v-for="(data, index) in paginatedInfoDoctor" :key="index"
                        ...
                        <td class="px-3 py-4 min-w-[200px] max-w-[201px]">
                            ...
                            <p v-else-if="!data.Gender" class="font-gotham font-light leading-4 text-black text-base">Tidak Diketahui</p>
                        </td>
                        <td class="px-3 py-4 min-w-[200px] max-w-[201px]">
                            <p v-if="data.PhoneNumber" class="font-gotham font-light leading-4 text-black text-base">{{ data.PhoneNumber }}</p>
                            <p v-else-if="!data.PhoneNumber" class="font-gotham font-light leading-4 text-black text-base">Tidak Diketahui</p>
                        </td>
