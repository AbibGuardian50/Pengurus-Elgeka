    ...
    <div class="flex bg-offwhite">
        ...
        <div>
            ...
            <div class="ml-8 flex items-center justify-between border-b border-lightgray">
                ...
                <a href="/HasilLabBloodPressure" class="flex items-center gap-2 font-inter font-medium text-[20px] leading-5 text-blueblack"><span><svg width="18" height="15" viewBox="0 0 18 15" fill="none"
                ...
                <tbody>
                    <tr v-for="(data, index) in paginatedInfoPatient" :key="index" class="divide-y divide-gray-200">
                        ...
                        <td class="px-3 py-4 min-w-[250px] max-w-[251px]">
                            <p class="font-gotham font-light leading-4 text-black text-base">{{ data.DataSys }}</p>
                        </td>
                        <td class="px-3 py-4 min-w-[250px] max-w-[251px]">
                            <p class="font-gotham font-light leading-4 text-black text-base">{{ data.DataDia }}</p>
                        </td>
                        <td class="px-3 py-4 min-w-[250px] max-w-[251px]">
