...
export default {
    ...
    methods: {
        ...
        updatePaginatedData() {
            ...
            this.paginatedInfoLabHeartRate = this.InfoLabHeartRate.slice(startIndex, endIndex);
        },
        goToPage(pageNumber) {
    ...
    <div class="flex bg-offwhite">
        ...
        <div>
            ...
            <div class="ml-8 flex items-center justify-between border-b border-lightgray">
                ...
                <a href="/HasilLabHeartRate" class="flex items-center gap-2 font-inter font-medium text-[20px] leading-5 text-blueblack"><span><svg width="18" height="15" viewBox="0 0 18 15" fill="none"
            ...
            <table class="ml-8 min-w-full divide-y divide-gray-200 overflow-x-auto w-[1200px]">
                ...
                <tbody>
                    <tr v-for="(data, index) in paginatedInfoLabHeartRate" :key="index" class="divide-y divide-gray-200">
                        <td
