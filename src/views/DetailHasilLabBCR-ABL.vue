    ...
    <div class="flex bg-offwhite">
        ...
        <div class="bg-offwhite">
            ...
            <div class="overflow-x-auto max-w-full">
                <table class="ml-8 min-w-full divide-y divide-gray-200 overflow-x-auto">
                    <thead>
                        <tr class="border-b-[0.5px] border-b-lightgray">
                            <th @click="sortData('no')" scope="col"
                                class="cursor-pointer flex items-center gap-1 px-3 max-lg:px-1 py-3 max-w-[50px] text-left font-bold font-poppins text-black text-base">
                                No
