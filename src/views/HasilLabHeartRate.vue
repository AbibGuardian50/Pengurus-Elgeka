        ...
        <div class="flex flex-col gap-4 pt-4 pl-4">
            <div class="flex gap-4 items-center">
                <div class="flex flex-col items-center justify-center gap-4 bg-white rounded-lg pl-4 pr-8">
                    ...
                    <Bar v-if="loaded" :data="DataLabHeartRate" :options="HasilLabHeartRateOptions"
                ...
                <div
                    ...
                    <div class="">
                        <a href="/DetailHasilLabHeartRate"><button class="font-opensans text-white flex items-center gap-2 pb-4">Read
